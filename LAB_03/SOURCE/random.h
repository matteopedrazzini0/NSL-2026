...
public:
  ...
  // Destructor
  ~Random();
  // Method to intialize the RNG
  void Initialize_RNG(std::string file_Primes, std::string file_Seed);
  ...
  // Method to generate a random number with linear probability distribution
  double retta(double m, double q, double xmin, double xmax);
};
